...
- **Cable Well:** nine machines, a stepped climb through suspended platforms, high firing positions and recoil shortcuts. Every platform route also works with ordinary jumps and no upgrades.
- **Receiver Gallery:** ten machines, alternating solid cover and raised firing positions, with room to flank or use blue allies.
...
Stages 8–10 (rooms 9–11) use the new layouts. **Stage 11 currently rejoins the existing Cooling boss**, then proceeds to Reclamation. Switchboard and Caller are still future work. This is three authored layouts, each mirrored; it is not the weekend plan's eventual six distinct arrangements.
...
Browser inspection covers the fork's two signs, the live Annex layout, minimal HUD and pause controls. Full-update balance, Caller, Switchboard, extra arrangements, regional music and release packaging remain on the [weekend plan](dead-signal-weekend.md).
