...
The [route integration](dead-signal-route.md), first-Annex Spoof offer, regional discovery and Daily 80 are implemented. [Caller and its Spoof behavior](dead-signal-caller.md), [The Switchboard](dead-signal-switchboard.md) and [six combat arrangements](dead-signal-layouts.md) are implemented. [Regional audio](dead-signal-audio.md) is implemented. Final balance and release acceptance remain open in the [weekend plan](dead-signal-weekend.md).
