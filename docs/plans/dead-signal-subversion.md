...
The [route integration](dead-signal-route.md), first-Annex Spoof offer, regional discovery and Daily 80 are implemented. [Caller and its Spoof behavior](dead-signal-caller.md) and [The Switchboard](dead-signal-switchboard.md) are implemented. Further layouts and regional sound remain open in the [weekend plan](dead-signal-weekend.md).
