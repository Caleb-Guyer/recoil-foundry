...
**Card:** Shell blasts cut a longer cone in the impact direction. Less side coverage.
...
**Card:** Shells split their blast between the impact and three short-lived bomblets.
